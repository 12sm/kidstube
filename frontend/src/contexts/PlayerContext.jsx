...
export function PlayerProvider({ children }) {
  ...
  // Stop entirely
  const close    = useCallback(() => { setVideoId(null); setMinimized(false); setNextVideo(null); }, []);

  return (
    <PlayerContext.Provider value={{ videoId, minimized, nextVideo, setNextVideo, openVideo, minimize, expand, close }}>
      {children}
