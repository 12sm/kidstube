...
**Session type:** Single-evening autonomous implementation — no human input required mid-run.
**Outcome:** Sideloaded Roku channel that shows Weston/Emery's curated feed and plays videos via yt-dlp stream extraction.
...
- [ ] Profile select shows Weston/Emery cards, D-pad toggles focus
